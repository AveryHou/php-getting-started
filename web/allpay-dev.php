...
try
{
	...
	$oPayment->Send['ClientBackURL'] ="https://hungrybeephp.herokuapp.com/return-dev.php";
	...
	$oPayment->SendExtend['PaymentInfoURL']="https://hungrybeephp.herokuapp.com/return-dev.php";//接受訂單狀態 回傳程式名稱 可在此程式內將付款方式寫入你的訂單中 payment_info.php 與 return.php 程式內容一樣
	// 加入選購商品資料。
