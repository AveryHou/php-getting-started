...
try
{
	...
	$time=time();
	/* 基本參數 */
	$oPayment->Send['ReturnURL'] = "http://wintopinfo.com/hungrybeeuser/return-dev.php";//請填入你主機要接受訂單付款後狀態 回傳的程式名稱 記住 該網址需能對外
	$oPayment->Send['ClientBackURL'] ="http://wintopinfo.com/hungrybeeuser/return-dev.php";
	
	$oPayment->Send['OrderResultURL'] = "http://wintopinfo.com/hungrybeeuser/return-dev.php";//請填入你主機要接受訂單付款後狀態 回傳的程式名稱 記住 該網址需能對外
	...
	$oPayment->SendExtend['PaymentInfoURL']="http://wintopinfo.com/hungrybeeuser/return-dev.php";//接受訂單狀態 回傳程式名稱 可在此程式內將付款方式寫入你的訂單中 payment_info.php 與 return.php 程式內容一樣
	// 加入選購商品資料。
